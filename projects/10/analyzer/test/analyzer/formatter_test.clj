...
(deftest outputting-method-variables
  (let [jack-code ["class Main { method void foo(int bar, Fraction baz) {} }"]
        parse-tree (parse-tokens (tokenize-instructions jack-code))]
    (are [location value]
        (= value (get-in (parse-xml (with-out-str (output-parse-tree parse-tree))) location))
      [:tag] :class
      ...
      [:content 3 :content 4 :content 0 :tag] :keyword
      [:content 3 :content 4 :content 0 :content 0] " int "
      [:content 3 :content 4 :content 1 :tag] :identifier
      [:content 3 :content 4 :content 1 :content 0] " bar "
      [:content 3 :content 4 :content 2 :tag] :symbol
      [:content 3 :content 4 :content 2 :content 0] " , "
      [:content 3 :content 4 :content 3 :tag] :identifier
      [:content 3 :content 4 :content 3 :content 0] " Fraction "
      [:content 3 :content 4 :content 4 :tag] :identifier
      [:content 3 :content 4 :content 4 :content 0] " baz ")))
